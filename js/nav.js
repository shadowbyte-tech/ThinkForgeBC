...
<div class="rx-trace-bar" role="region" aria-label="Active Resource Trace">
  ...
  window.RX.mountTraceBar = function () {
    var curPage = window.location.pathname.split('/').pop() || 'index.html';
    var showTraceOn = ['material-detail.html', 'match-explorer.html', 'material-journey.html', 'material-bank.html', 'dashboard.html', 'intelligence.html', 'marketplace.html', 'list-material.html', 'negotiations.html'];
